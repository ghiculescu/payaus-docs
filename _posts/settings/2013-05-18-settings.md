...
* Leave blank. Use this if you do not want automatic tagging applied to your shifts. Note that some accounting packages will raise errors if you try to import tag data that is not recognised. In such cases you can disable this feature by choosing to leave tags blank.
