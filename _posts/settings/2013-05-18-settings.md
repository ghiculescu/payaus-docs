...
Aggressive mode is enabled by default.
...
#### Allow managers to see costs

If enabled, managers will be able to see staff hourly rates and costs on [timesheets](../../timesheets/) and [staff profiles](../../staff/team/). If disabled, this data will be hidden from managers. This is enabled by default.
