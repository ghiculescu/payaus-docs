...
![Leave form on the timesheets menu](/img/timesheets/leave_form_menu.png)
...
![Leave form on the timesheets menu](/img/timesheets/leave_calendar_menu.png)

![Leave form](/img/timesheets/leave_calendar.png)
