...
* **Employee (ID and name) doesn't have a pay run calendar**. This employee has not got a Xero payroll calendar. [Choose a payroll calendar for them](http://help.xero.com/Help/PayrollEmployment.htm#Calendar).
