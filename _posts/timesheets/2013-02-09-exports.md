...
1. Your Xero organisation should be activated for Xero Payroll - this is only available to Australian organisations currently. Contact Xero if you are unsure.
...
PayAus will only export [*approved*](../approving-rejecting-deleting/) timesheets to Xero. Choose the *Export to Xero* button from the *Export to...* menu to commence the process. You'll be redirected to a screen where you can authorise PayAus to access your Xero account. Choose your organisation and click *Authorise*.

![Authorising with Xero](/img/timesheets/xero_auth.png)
